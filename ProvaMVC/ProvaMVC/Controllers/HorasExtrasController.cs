...
namespace ProvaMVC.Controllers
{
    public class HorasExtrasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HoraExtraID,Data,Horas,Inicio,Fim,FuncionarioID")] HoraExtra horaExtra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HoraExtraID,Data,Horas,Inicio,Fim,FuncionarioID")] HoraExtra horaExtra)
        {
            if (ModelState.IsValid)
            {
